import {latLng, Marker, Util} from 'leaflet';

function interpolatePosition(p1, p2, duration, t) {
    let k = t / duration;
    k = (k > 0) ? k : 0;
    k = (k > 1) ? 1 : k;
    return latLng(p1.lat + k * (p2.lat - p1.lat),
        p1.lng + k * (p2.lng - p1.lng));
};

export var MovingMarker = Marker.extend({
    ...
    initialize: function (latlngs, durations, options) {
        ...
        this._state = Marker.MovingMarker.notStartedState;
        this._startTime = 0;
    ...
    isRunning: function () {
        return this._state === Marker.MovingMarker.runState;
    },

    isEnded: function () {
        return this._state === Marker.MovingMarker.endedState;
    },

    isStarted: function () {
        return this._state !== Marker.MovingMarker.notStartedState;
    },

    isPaused: function () {
        return this._state === Marker.MovingMarker.pausedState;
    },
    ...
    pause: function () {
        ...
        this._state = Marker.MovingMarker.pausedState;
        this._stopAnimation();
    ...
    stop: function (elapsedTime) {
        ...
        this._state = Marker.MovingMarker.endedState;
        this.fire('end', {elapsedTime: elapsedTime});
    },

    addLatLng: function (latlng, duration) {
        this._latlngs.push(latLng(latlng));
        this._durations.push(duration);
    },

    moveTo: function (latlng, duration) {
        this._stopAnimation();
        this._latlngs = [this.getLatLng(), latLng(latlng)];
    ...
    _startAnimation: function () {
        this._state = Marker.MovingMarker.runState;
    ...
    _animate: function (timestamp, noRequestAnim) {
        ...
        if (elapsedTime != null) {
            ...
            let p = interpolatePosition(this._currentLine[0],
                this._currentLine[1],
